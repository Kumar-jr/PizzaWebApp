    ...
    <br />
     <center>
            ...
            <table>
                ...
                <tr>
                    <td style="margin-left: 40px"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Cheese n Corn Pizza&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="Button1" runat="server" Text="Buy" OnClick="Button1_Click1"></asp:Button></b></td>
                    <td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Delux Pizza&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="Button2" runat="server" Text="Buy" OnClick="Button2_Click"></asp:Button></b></td>
